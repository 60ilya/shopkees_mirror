...
external_domains = (
    # actually, the shopkees.com has many sub-domains, but we just add one of them for example
    # the following `Automatic Domains Whitelist` would detect and add the others automatically
    #
    # 实际上, shopkees.com 有大量的子域名, 但是我们在这里并不把它们全部添加进来, 而只是添加一个作为示例
    # 下面的 `Automatic Domains Whitelist` 功能会自动检测并添加其他的子域名
     "uae-en.shopkees.com",
    "webdisk.api.shopkees.com",
    "www.api.shopkees.com",
    "saudi-ar.shopkees.com",
    "skd.shopkees.com",
    "webmail.shopkees.com",
    "shopkees.com",
    "webmail.crm.shopkees.com",
    "sellertest.shopkees.com",
    "machine.shopkees.com",
    "webmail.api.shopkees.com",
    "webdisk.skd.shopkees.com",
    "old.shopkees.com",
    "ms1.shopkees.com",
    "kuwait-ar.shopkees.com",
    "webmail.blog.shopkees.com",
    "cpanel.skd.shopkees.com",
    "uae-ar.shopkees.com",
    "webdisk.crm.shopkees.com",
    "orders.shopkees.com",
    "oman-en.shopkees.com",
    "cpcontacts.shopkees.com",
    "mail.skd.shopkees.com",
    "cpcalendars.shopkees.com",
    "dm.shopkees.com",
    "cpanel.blog.shopkees.com",
    "email.shopkees.com",
    "test.shopkees.com",
    "hrm.shopkees.com",
    "www.skd.shopkees.com",
    "qatar-ar.shopkees.com",
    "bahrain-en.shopkees.com",
    "omanstore.shopkees.com",
    "business.shopkees.com",
    "mail.crm.shopkees.com",
    "mailgw.shopkees.com",
    "bkp.shopkees.com",
    "sellerdemo.shopkees.com",
    "staging.shopkees.com",
    "store.shopkees.com",
    "apptest.shopkees.com",
    "crm.shopkees.com",
    "magento.shopkees.com",
    "newtest.shopkees.com",
    "cpanel.shopkees.com",
    "api.shopkees.com",
    "webdisk.shopkees.com",
    "pma.shopkees.com",
    "mobapp.shopkees.com",
    "flutter.shopkees.com",
    "marketing.shopkees.com",
    "oman.shopkees.com",
    "om.shopkees.com",
    "oman-ar.shopkees.com",
    "kuwait-en.shopkees.com",
    "ns1.shopkees.com",
    "webdisk.blog.shopkees.com",
    "mail.api.shopkees.com",
    "www.blog.shopkees.com",
    "www.crm.shopkees.com",
    "qatar-en.shopkees.com",
    "webmail.skd.shopkees.com",
    "en.shopkees.com",
    "cpanel.crm.shopkees.com",
    "seller.shopkees.com",
    "phpadmin.shopkees.com",
    "images.shopkees.com",
    "dev.shopkees.com",
    "www.cdn.shopkees.com",
    "mailx.shopkees.com",
    "mailin.shopkees.com",
    "ns2.shopkees.com",
    "cpanel.api.shopkees.com",
    "www.shopkees.com",
    "global-ar.shopkees.com",
    "saudi-en.shopkees.com",
    "blog.shopkees.com",
    "mail.blog.shopkees.com",
    "global-en.shopkees.com",
    "bahrain-ar.shopkees.com",
    "cdn.shopkees.com", 
    "apitest.shopkees.com", 
    "invoice.shopkees.com", 
    "mail.shopkees.com", 
    "logistics.shopkees.com"
)
...
domains_whitelist_auto_add_glob_list = ('*.shopkees.com',)
...
#   eg: shopkees.com is the same of www.shopkees.com
#       format: ('shopkees.com',)
